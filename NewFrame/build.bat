...
set "FRAMEWORK_FOLDER=C:\SPRINT\Servlet_generalization_08\NewFrame\"
set FRAMEWORK="C:\SPRINT\Servlet_generalization_08\NewFrame\Framework"
set TOMCAT="C:\Program Files\Apache Software Foundation\Tomcat 10.0\webapps"
set TESTFRAMEWORK="C:\SPRINT\Servlet_generalization_08\NewFrame\TestFramework"

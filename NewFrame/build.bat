...
set "FRAMEWORK_FOLDER=C:\SPRINT\Framew-Sprint10\NewFrame\"
set FRAMEWORK="C:\SPRINT\Framew-Sprint10\NewFrame\Framework"
set TOMCAT="C:\Program Files\Apache Software Foundation\Tomcat 10.0\webapps"
set TESTFRAMEWORK="C:\SPRINT\Framew-Sprint10\NewFrame\TestFramework"
